...
| API                                                          | 操作名         | 操作描述                           |
| ------------------------------------------------------------ | -------------- | -------------------------- |
| [GET Bucket（List Object）](https://cloud.tencent.com/document/product/436/7734) | 查询对象列表   | 	查询指定账号下所有存储桶列表            |
...
Head Object 接口请求可以查询对应 Object 的 meta 信息数据，Head 的权限与 Get 的权限一致。
...
GET Object acl 接口用来查询 Object（文件/对象）的 ACL。只有 Bucket 的持有者才有权限操作。
...
完整的队列使用例子，请参阅 [demo-queue](https://github.com/tencentyun/cos-js-sdk-v5/tree/master/demo/queue)。
