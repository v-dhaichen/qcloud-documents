...
<table>
   <tr>
      <th colspan=3 rowspan=3>地域</th>
      <th rowspan=3>存储类型</th>
      <th colspan=6>计费项</th>
   </tr>
   <tr>
      <th rowspan=2>存储容量费用<br>（元/GB/月）</th>
      <th rowspan=2>读/写请求费用<br>（元/万次）</th>
      <th rowspan=2>数据取回费用<br>（元/GB）</th>
      <th colspan=3>流量费用<br>（元/GB）</th>
   </tr>
   <tr>
      <th>外网下行流量</th>
      <th>CDN 回源流量</th>
