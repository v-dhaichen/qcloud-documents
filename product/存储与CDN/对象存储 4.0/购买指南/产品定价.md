...
<table>
   ...
   <tr>
      <td rowspan=2 nowrap="nowrap">广州、北京</td>
...
| 不同地域之间的传输方向              | 收发方式 | 全球加速流量费用<br>（元/GB） |
| -------------------------------- | -------- | ----------------------------- |
| 中国大陆 - 中国大陆地域             | 上行     | 0.5                           |
| 中国大陆 - 中国大陆地域             | 下行     | 0.5                           |
...
资源包是单个或多个计量项组合的固定套餐。目前，对象存储提供的资源包类型包括：**标准存储容量包**、**低频存储容量包**、**归档存储容量包**、**外网下行流量包**、**CDN 回源流量包**、**全球加速流量包**。
...
<table>
   ...
   <tr>
      <td rowspan="16">仅<br>中国<br>大陆</td>
      <td>10GB</td>
      <td>3.6</td>
      <td>10.65</td>
      <td>21</td>
   ...
   <tr>
      <td rowspan="16">包含中国<br>香港<br>和<br>海外</td>
      <td>10GB</td>
      <td>9</td>
      <td>26.63 </td>
      <td>52.5</td>
