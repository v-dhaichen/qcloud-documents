...
### 资源包定价
对象存储 COS 现针对中国大陆推出两种资源包：存储空间包和外网下行流量包。其中存储空间包有标准存储空间包、归档存储空间包两种可选。
...
<table>
   <tr>
	    <th rowspan="1">适用地域</th>
      <th rowspan="1">资源包类型</th>
      <th rowspan="1">规格</th>
      <th>购买时长</th>
      <th>售价（元）</th>
   </tr>
   <tr>
	    <td rowspan="3">所有中国大陆地域</td>
